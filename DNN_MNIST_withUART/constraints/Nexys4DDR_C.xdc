...
# For 100 MHz source clock
# create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {clk_i}];
# For 80 MHz clock
# create_clock -add -name sys_clk_pin -period 12.50 -waveform {0.00 6.25} [get_ports {clk_i}];
# For 60 MHz clock
create_clock -add -name sys_clk_pin -period 16.667 -waveform {0.00 8.333} [get_ports {clk_i}];
